...
def test_query_models(session):
    ...
    commit = (
        ...
        .filter_by(sha="feb3a2837630c0e51447fc1d7e68d86f964a8440")
        .first()
    )
    ...
    commit2 = (
        session.query(Commit)
        .filter_by(sha="ee474544052762d314756bb7439d6dab73221d3d")
        .first()
    )
    ...
    repo = (
        ...
        .filter_by(clone_url="git@github.com:super/repo.git")
        .first()
    )
...
def test_ensure_repository(session):
    ...
    repo2 = ensure_repository(
        session, "https://github.com/sloppycoder/git-indexer.git", "github"
    )
